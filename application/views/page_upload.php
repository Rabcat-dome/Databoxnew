...
echo form_open_multipart('http://127.0.0.1/j3databoxnew/index.php/mainFunction/save_upload', $attributes); ?>
			  ...
			  <span class="add-on1"  >&nbsp;&nbsp;&nbsp;</span>
                    ...
                    <div id="errorBlock" class="help-block"></div>
                                    ...
                                    <tbody>
                                    <input type="text" name="databox_save" id="databox_save" > </input>
                                    <input type="text" name="subject_save" id="subject_save" > </input>
                                    <input type="text" name="subject_save" id="subject_save" > </input>
                                    <input type="text" name="databox_search_text_save" id="databox_search_text_save" > </input>
...
<?php $this->load->view('java/javascript_upload_insert'); ?>
								    ...
								    <?php  foreach ($data_group_up as $row){  
                                                                     
                                                                     $divisId_b =  $row['divisId'];
                                                                     if($divisId==$divisId_b){
                                                                        ?>

			                                            <option  value='<?php echo $row['group_Id']."-table" ?>' <?php  if($group_Id==$row['group_Id']){   echo  "selected"; }?> >		                                                                                                    
