...
$config['hosts'] = array('apricot.j3.mil');
...
$config['proxy_user'] = 'proxy.user@j3.mil';

// proxy pass: the password for the proxy_user
$config['proxy_pass'] = 'Forldapsession0';
